...
class HPIDLitModule(LightningModule):
    ...
    def _log_energy_w2(self, prefix="val"):
        if prefix == "test":
            ...
            generated_samples, _ = self.generate_samples(
    ...
    def eval_epoch_end(self, prefix: str):
        ...
        if self.nll_with_cfm:
            unprioritized_buffer_samples, _, _, _ = self.buffer.sample(
    ...
    def on_test_epoch_end(self) -> None:
        ...
        for i in range(n_batches):
            start = time.time()
            samples, trajectory = self.generate_samples(
    ...
    def setup(self, stage: str) -> None:
        ...
        self.buffer.add(init_states, init_energies, init_trajectory)
